...
public class SHA1 {
	...
	public static String getDigestOfString(byte[] byteData) {
		SHA1 sha1 = new SHA1();
		return byteArrayToHexString(sha1.getDigestOfBytes(byteData));
	}
	
	public static String getDigestOfString(String data,String disturb) throws UnsupportedEncodingException {
		return getDigestOfString((data+disturb).getBytes("utf-8"));
	}
